...
internal class EditProfileViewModel @Inject constructor(
    ...
    @AsyncTaskUtilsQualifier(ScreensAnalytic.EDIT_PROFILE) private val asyncTaskUtils: AsyncTaskUtils,
    ...
    override fun sendOpenScreenAnalytic() {
        asyncTaskUtils.runAsyncTask(viewModelScope) {
            analyticSender.sendEvent(CommonAnalyticEvent.OpenScreen(ScreensAnalytic.EDIT_PROFILE))
        }
    }
