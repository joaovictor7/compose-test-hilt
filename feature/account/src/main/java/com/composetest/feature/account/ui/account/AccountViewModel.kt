...
internal class AccountViewModel @Inject constructor(
    ...
    @AsyncTaskUtilsQualifier(ScreensAnalytic.ACCOUNT) private val asyncTaskUtils: AsyncTaskUtils,
    ...
    override fun sendOpenScreenAnalytic() {
        asyncTaskUtils.runAsyncTask(viewModelScope) {
            analyticSender.sendEvent(CommonAnalyticEvent.OpenScreen(ScreensAnalytic.ACCOUNT))
        }
    }
