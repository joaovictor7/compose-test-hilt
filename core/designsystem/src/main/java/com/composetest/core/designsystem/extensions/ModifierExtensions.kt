...
@Composable
fun Modifier.defaultTopHorizontalScreenPadding() =
    statusBarsPadding().padding(horizontal = spacings.sixteen)

@Composable
fun Modifier.defaultScreenPaddings() =
    defaultTopHorizontalScreenPadding().navigationBarsPadding()
